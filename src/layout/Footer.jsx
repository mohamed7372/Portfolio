...
const Footer = () => {
  return (
    ...
    <div className="">
      <SocialMedia />
      <div className="hidden md:flex flex-col items-center fixed lg:flex right-20 xl:right-16 bottom-0">
        <div className="h-28 w-1 border-l border-secondary-200 relative">
          <a
            href="mailto:benrabahmohamed530@gmail.com"
