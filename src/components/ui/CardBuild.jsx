    ...
    return (
        <div className='flex mb-20 items-center'>
            ...
            <div className={`w-1/3 flex flex-col ${inverse ? 'items-start' : 'items-end'} justify-center relative ${inverse && 'order-1'}`}>
                ...
                <ul className={`flex items-center justify-end ${build.nbrLink > 0 && 'h-12'}`}>
                    {build.git !== '' &&
                        <li className='mt-4 ml-3 cursor-pointer'>
                            <a href={build.git}>
                                <svg fill="#ccd6f6" width="16px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
