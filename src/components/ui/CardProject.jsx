        ...
        <div className='bg-secondary-250 rounded-lg shadow-lg px-4 h-[270px]' data-aos='zoom-in'>
            <div className='flex justify-between items-center h-16'>
                ...
                <ul className='flex items-center justify-end'>
                    <li className={`ml-3 ${project.links.github === '' && 'hidden'}`}>
                        <a href={project.links.github}>
                            <svg fill="white" width="16px" height="800px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className={`ml-3 ${project.links.web === '' && 'hidden'}`}>
                        <a href={project.links.web}>
