...
const Project = () => {
  ...
  return (
    <div className="responsive flex flex-col justify-center items-center min-h-screen">
      <h4 className="text-sm text-primary-200" data-aos="fade-left">
        view the archive
      </h4>
      <h1
        className="text-xl md:text-5xl text-secondary-100 font-bold mt-4 mb-10 text-center"
        data-aos="fade-right"
      >
      ...
      <ul className="flex md:mb-8 border-b border-secondary-200">
        <li
          className={`${
            type === 0
              ? "text-primary-200 border-b border-primary-200"
              : "text-secondary-200"
          } pb-4 px-4 font-semibold cursor-pointer`}
          onClick={() => setType(0)}
        >
          Web
        </li>
        <li
          className={`${
            type === 1
              ? "text-primary-200 border-b border-primary-200"
              : "text-secondary-200"
          } px-4 font-semibold cursor-pointer`}
          onClick={() => setType(1)}
        >
          Mobile
        </li>
