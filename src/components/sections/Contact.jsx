        ...
        <div className='responsive min-h-screen flex flex-col justify-center items-center' id='contact'>
            {!sendMsg
                ...
                <>
                    ...
                    <h1 className='text-xl md:text-5xl font-bold text-secondary-100 mt-4 mb-4' data-aos='fade-up'>Get In Touch</h1>
                    <p className='text-xs md:text-md text-secondary-200 w-full md:w-1/2 text-center mb-14' data-aos='fade-up'>Although I’m currently looking for any new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I’ll try my best to get back to you!</p>
