        ...
        <div className='responsive flex flex-col justify-center items-center min-h-screen' id='about'>
            ...
            <div className='flex flex-col md:flex-row h-fit'>
                <div data-aos="fade-up" className='w-full md:w-2/3'>
                    <p className='text-center md:text-left'>Welcome! My name is <span className='font-extrabold'>BENRABAH Mohamed</span> and I enjoy creating things that live online. My interest in <span className='text-primary-200'> web development started in 2021</span> when I decided to try building a website for my graduation project.</p>
                    <p className='mt-4 text-center md:text-left'>I loved the field a lot and gave it a lot of time to develop my skills, as I learned well by working on projects for our club
                    ...
                    <p className='mt-4 text-center md:text-left'>Also, I am in the process of launching <span className='text-primary-200'>my own project</span> on <span className='text-primary-200'>YouTube</span> and <span className='text-primary-200'>Spotify</span> <span className='text-secondary-100 font-bold'>SOON</span>.</p>
                    <p className='mt-4 text-center md:text-left'>Here are a few technologies I’ve been working with recently:</p>
